...
const ICONS = {
  ...
  simulador: (
    <svg width="17" height="17" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 7H7a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V9a2 2 0 00-2-2h-2M9 7V5a2 2 0 012-2h2a2 2 0 012 2v2M9 7h6M9 12h6M9 16h4"/>
    </svg>
  ),
  equipe: (
    <svg width="17" height="17" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
      ...
      <nav style={{ flex: 1, padding: 12 }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
          ...
          <div style={{ marginTop: 8, display: 'flex', flexDirection: 'column', gap: 2 }}>
            ...
            <NavItem item={{ to: '/simulador',    label: 'Simulador',     icon: ICONS.simulador }} />
